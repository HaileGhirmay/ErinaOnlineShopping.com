...
@CrossOrigin(origins ="http://localhost:4200" , maxAge=3600, allowedHeaders = "*",  methods = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE, RequestMethod.PATCH, RequestMethod.OPTIONS})
public class AdminController {
    ...
    public Product updateProductStatus(@RequestBody boolean isApproved, @PathVariable String productId){
        return adminService.updateProductStatus(true, productId);
    }
